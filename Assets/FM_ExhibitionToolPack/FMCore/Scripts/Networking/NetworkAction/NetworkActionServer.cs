...
public class NetworkActionServer : MonoBehaviour {
    ...
    bool stop = false;
    private List<System.Net.Sockets.TcpClient> clients = new List<System.Net.Sockets.TcpClient>();
    ...
    IEnumerator NetworkServerStart()
    {
        ...
        {
            while (FmLoom.numThreads >= FmLoom.maxThreads)
            {
                yield return null;
            }
