...
public class ArrangeViewBase<TViewModel> : UnityMono, IArrangeView where TViewModel : ViewModelBase, new()
{
    public ArrangeViewType viewType;
    ...
    protected override void Start()
    {
        ...
        //就要在这里判断下，加入ui管理
        ArrangeUiMgr.GetInstance().CheckAddView(this);
    }
    ...
    {
        ArrangeUiMgr.GetInstance().CloseView(ViewType);
    }
    ...
    protected override void OnDisable()
    {
        ...
        if (ArrangeUiMgr.GetInstance().IsOpenView(ViewType))
        {
            ArrangeUiMgr.GetInstance().CloseView(ViewType);
