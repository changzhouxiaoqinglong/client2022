...
public class FollowPlayerCamera : MainCameraItemBase
{
    /// <summary>
    ...
    public void FollowTarget()
    {
        ...
        //if (Input.GetMouseButton(0)) 获取鼠标左键按下
        ...
        if (Mathf.Abs(Mouse.current.scroll.ReadValue().y) > deadZone)
        {
            desiredDistance = Mathf.Clamp(distance - (Mouse.current.scroll.ReadValue().y * mouseWheelSensitivity),
