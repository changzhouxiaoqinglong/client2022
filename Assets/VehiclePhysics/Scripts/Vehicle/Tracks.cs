...
namespace NWH.VehiclePhysics
{
    ...
    public class Tracks
    {
        ...
        public void Update()
        {
            ...
            {
                leftTrackRenderer.material.SetTextureOffset("_BaseMap", leftTrackRenderer.material.mainTextureOffset + leftDistance * textureOffsetDirection);
            ...
            {
                rightTrackRenderer.material.SetTextureOffset("_BaseMap", rightTrackRenderer.material.mainTextureOffset + rightDistance * textureOffsetDirection);
