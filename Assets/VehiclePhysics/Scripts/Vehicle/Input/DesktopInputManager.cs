        ...
        void Update()
        {
            ...
            try
            {
                ...
                if (vehicleController.transmission.transmissionType == Transmission.TransmissionType.Manual)
                {
                    try
                    {
                        if (vehicleController.transmission.clutchPedalPressedPercent ==1)
                        {
                ...
                {
                    horizontal = 0f; //Input.GetAxis("Horizontal");
                }
                else
                {
                ...
                if (inputType == InputType.Standard)
                {
                    ...
                    {
                        vertical = 0f;//Input.GetAxisRaw("Vertical");
                    }
                ...
                //{
                    ...
                    vehicleController.input.Handbrake = Keyboard.current.spaceKey.wasPressedThisFrame ? 1f : 0f;
                //}
