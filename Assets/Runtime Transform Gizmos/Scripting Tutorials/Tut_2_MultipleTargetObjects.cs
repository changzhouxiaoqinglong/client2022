...
namespace RTG
{
    ...
    public class Tut_2_MultipleTargetObjects : MonoBehaviour
    {
        ...
        private AreaArrange areaArrange;
        /// <summary>
        ...
        private void Start()
        {
            ...
            areaArrange = GameObject.Find("SceneCtr").GetComponent<AreaArrange>();
        }
        ...
        private void Update()
        {
                ...
                RTGizmosEngine.Get.HoveredGizmo == null)
            {
                ...
                {
                    if (pickedObject.transform.parent!=null&&pickedObject.transform.parent.name == "Car")
                    {
                        areaArrange.ChoiceState(pickedObject);
                    }
